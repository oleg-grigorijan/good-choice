...
insert into subject (id, name, description, brand_id, is_shown, reviews_count, average_mark)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'name', 'description', '40e6215d-b5c6-4896-987c-f30f3678f608', true, 0, null);

select * from subject;

insert into actor (id, first_name, last_name, email, role, password, created_timestamp, profile_image_id, is_active)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'first_name', 'last_name', 'email', 'REVIEWER', 'password', now(), null, true);

select * from actor;

insert into review (id, title, reviewer_id, subject_id, mark, is_shown, upvotes_count, downvotes_count)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'title', '40e6215d-b5c6-4896-987c-f30f3678f608', '40e6215d-b5c6-4896-987c-f30f3678f608', 4, true, 0, 0);
...
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'first_name', 'last_name', 'email', 'REVIEWER', 'password', now(), null, true);
insert into actor (id, first_name, last_name, email, role, password, created_timestamp, profile_image_id, is_active)
values ('40e6215d-b5c6-4896-987c-f30f3678f603', 'first_name', 'last_name', 'newemail', 'REVIEWER', 'password', now(), null, true);
insert into review (id, title, reviewer_id, subject_id, mark, is_shown, upvotes_count, downvotes_count)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'title', '40e6215d-b5c6-4896-987c-f30f3678f608', '40e6215d-b5c6-4896-987c-f30f3678f608', 4, true, 0, 0);
...
delete from review where id = '40e6215d-b5c6-4896-987c-f30f3678f608';
delete from actor where id = '40e6215d-b5c6-4896-987c-f30f3678f603';
delete from actor where id = '40e6215d-b5c6-4896-987c-f30f3678f608';
delete from subject where id = '40e6215d-b5c6-4896-987c-f30f3678f608';
delete from brand where id = '40e6215d-b5c6-4896-987c-f30f3678f608';
...
insert into review (id, title, reviewer_id, subject_id, mark, is_shown, upvotes_count, downvotes_count)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'title', '40e6215d-b5c6-4896-987c-f30f3678f608', '40e6215d-b5c6-4896-987c-f30f3678f608', 4, true, 0, 0);
insert into review_comment (id, review_id, author_id, content, created_timestamp, is_shown, upvotes_count, downvotes_count)
values ('40e6215d-b5c6-4896-987c-f30f3678f608', '40e6215d-b5c6-4896-987c-f30f3678f608', '40e6215d-b5c6-4896-987c-f30f3678f608', 'content', now(), true, 0, 0);
...
values ('40e6215d-b5c6-4896-987c-f30f3678f608', 'name', 'description', '40e6215d-b5c6-4896-987c-f30f3678f608', true, 0, null);
insert into subject (id, name, description, brand_id, is_shown, reviews_count, average_mark)
values ('40e6215d-b5c6-4896-987c-f30f3678f603', 'name', 'description', '40e6215d-b5c6-4896-987c-f30f3678f608', true, 0, null);
